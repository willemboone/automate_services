...
class SendMessage(object):
    ...
    def send_sms(self, text, receiver):
        ...
        # lastly quit the server
        server.quit()
        print("text has been sent to ", receiver)


if __name__ == "__main__":
    sender = SendMessage()
    text = "testing my script"
    subj = "email with python"
    files = ["D:/monitoring/2020_7_26.png"]
    #sender.send_sms(text, 32476013631)
    sender.send_email(text=text, subject=subj, receiver="willemboone1995@gmail.com", files=files)
